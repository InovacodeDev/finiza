            ...
            {isOpen && (
                <div className="fixed inset-0 z-[60] overflow-hidden">
                    ...
                    <motion.div
                        ...
                        className="absolute inset-y-0 right-0 z-[70] w-full max-w-md bg-zinc-950/80 backdrop-blur-xl border-l border-zinc-800 shadow-2xl flex flex-col"
                    >
                                            ...
                                            >
                                                ...
                                                <div
                                                    className={cn(
                                                        ...
                                                        swipeLeftId === t.id && (shouldReduceMotion ? "" : "-translate-x-16"),
                                                        swipeLeftId === t.id && shouldReduceMotion && "opacity-50",
                                                    )}
                        ...
                        {isDeleteModalOpen && (
                            <div className="fixed inset-0 z-[80] flex items-center justify-center p-4">
                                ...
                                <motion.div
                                    ...
                                    className="relative bg-zinc-900 border border-zinc-800 p-6 rounded-2xl w-full max-w-sm shadow-2xl"
                                >
                                    <div className="mb-6">
