...
export function AgitationSection() {
    return (
        <section className="relative py-16 lg:py-24 px-6 lg:px-24 flex justify-center items-center">
            <div className="relative z-10 max-w-3xl text-zinc-400 text-lg sm:text-xl leading-relaxed border-l-2 border-zinc-800 pl-6 sm:pl-10 space-y-6">
                ...
                >
                    ...
                    arquivista cansado. Eles te dão um mapa exato de onde você tropeçou no mês passado, mas te deixam
                    completamente cego para o buraco que está a dois metros de distância amanhã.
                </motion.p>
                <motion.p
                    initial={{ opacity: 0, x: -30 }}
                    whileInView={{ opacity: 1, x: 0 }}
