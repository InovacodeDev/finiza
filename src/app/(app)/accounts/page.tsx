    ...
    return (
        <div className="flex flex-col items-center justify-center w-full max-w-4xl mx-auto p-6 text-center">
            <div className="flex flex-col items-center justify-center p-12 bg-zinc-900/50 backdrop-blur-xl border border-white/5 shadow-2xl rounded-3xl w-full max-w-2xl mt-12">
                ...
                <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-zinc-50 mb-4">Contas</h1>

                <p className="text-zinc-400 text-lg max-w-md mx-auto mb-8">
                    Esta área está atualmente em construção. Em breve você terá acesso a todas as suas contas bancárias
                    aqui.
                </p>
