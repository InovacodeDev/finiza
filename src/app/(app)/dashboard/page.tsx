    ...
    return (
        <div className="relative flex-1 w-full flex flex-col">
            <div className="sticky top-0 z-30 bg-zinc-950/90 backdrop-blur-md pt-2 pb-6 -mx-6 px-6 -mt-6 rounded-b-xl border-b border-zinc-900 shadow-sm mb-6">
                <PageHeader title="Dashboard" subtitle="Visão Geral" className="mb-0" />
            </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center w-full max-w-4xl mx-auto text-center mt-12">
                <div className="flex flex-col items-center justify-center p-12 bg-zinc-900/50 backdrop-blur-xl border border-white/5 shadow-2xl rounded-3xl w-full max-w-2xl">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-zinc-50 mb-4">Dashboard</h2>
